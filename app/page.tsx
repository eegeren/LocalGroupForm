...
export default function Page() {
  ...
  function validateStep3() {
    if (!educationLevel.trim()) return 'Eğitim durumu zorunludur.'
    if (!foreignLanguages.trim()) return 'Yabancı dil bilgisi zorunludur.'
  ...
  return (
    <main className="min-h-screen relative bg-white">
      ...
      <form onSubmit={onSubmit} className="bg-white rounded-2xl shadow p-6 space-y-8 border border-neutral-200">
        ...
        {step === 2 && (
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {/* Şık pill'lerle çoklu seçim: Çalışma Türü */}
              <div>
            ...
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input required name="educationLevel" placeholder="Lise, Ön Lisans, Lisans vb."
                ...
                <div>
                  ...
                  <input required name="foreignLanguages" placeholder="Örn: İngilizce B2; Almanca A2"
        ...
        {/* workType alanına csv yazıyoruz */}
